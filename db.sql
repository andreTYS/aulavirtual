...
-- ------------------------------------------------------------
-- mensajes: mensajeria interna directa entre dos usuarios,
-- opcionalmente asociada a un curso (para dar contexto docente-
-- estudiante). No reemplaza a los avisos (que son de difusion).
-- ------------------------------------------------------------
